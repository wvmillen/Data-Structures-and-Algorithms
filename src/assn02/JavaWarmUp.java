...
public class JavaWarmUp {
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println(date[highestItemIndex]);             //Displays which entry has the highest fee
        ...
        System.out.println(date[lowestItemIndex]);             //Displays which entry has the lowest fee
    ...
    static int getMaxPriceIndex(double[] priceT){
        ...
        return maxIndex; // modify this as well3
        // Your code ends here.
    }
